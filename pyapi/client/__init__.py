...
from .validation import HTTPXOpenAPIRequest, HTTPXOpenAPIResponse, prepare_request_params
...
class Client:
    ...
    def __init__(
        ...
        *,
        ...
        request_class: Type[RequestProtocol] = HTTPXOpenAPIRequest,
        response_class: Type[ResponseProtocol] = HTTPXOpenAPIResponse,
